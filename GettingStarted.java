...
{
    public static final String SERVER_ADDRESS = "media.contextmediainc.com";
    public static final int SERVER_PORT = 8090;
    public static final String USERNAME = "startup";
    public static final String PASSWORD = "context60601";
